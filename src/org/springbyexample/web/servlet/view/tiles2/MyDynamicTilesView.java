 ...
 */
public class MyDynamicTilesView extends AbstractUrlBasedView {

	final MyDynamicTilesViewProcessor dynamicTilesViewProcessor = new MyDynamicTilesViewProcessor();
